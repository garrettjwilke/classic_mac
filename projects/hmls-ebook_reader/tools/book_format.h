...
enum {
    ...
    kDefaultTextInset = 6,
    /*
     * Geneva 12 FontInfo on Classic Mac: ascent 10 + descent 3 + leading 3 = 16.
     * TETextBox uses this cell height; innerHeight 256 px / 16 = 16 visible lines.
     */
    kDefaultGenevaLineHeight = 16,
    /*
     * Subtract from maxPixelWidth when word-wrapping. Classic TextWidth is slightly
     * wider than our host-measured Geneva 12 table; wrapping early avoids index
     * page offsets that jump past visible text.
     */
    kLineWrapMargin = 8
};
