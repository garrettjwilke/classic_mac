...
resource 'MENU' (128) {
    ...
    apple;
    {
        "About EPUB Reader...", noIcon, noKey, noMark, plain;
...
resource 'MENU' (133) {
    ...
    "Chapters";
    {
        "Go to Chapter...", noIcon, noKey, noMark, plain;
        "-", noIcon, noKey, noMark, plain;
    }
};
...
resource 'DITL' (128) {
    {
        ...
        {15, 20, 75, 320}, StaticText { disabled, "hmls EPUB Reader v1.0\rFor Classic Macintosh System 6\r\rOpens .epub files with chapters and pages." };
    }
};
...
resource 'DITL' (134) {
    {
        {12, 16, 72, 334}, StaticText { disabled,
            "Importing EPUB...\r\r"
            "Extracting chapters from the\r"
            "spine and building the book file."
        };
        {88, 16, 108, 334}, StaticText { disabled, "Please wait..." };
    }
};
